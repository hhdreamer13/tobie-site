  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div className="flex flex-col w-full min-h-screen justify-center items-center gap-16">
        <div className="flex flex-col justify-center items-center  text-blur-out">
          <h1
            ref={titleRef}
          ...
          >
            L
            <span className="absolute w-16 top-[3rem] left-[2rem] sm:w-24 sm:top-[5.3rem] sm:left-[3rem] z-0">
              <LBranch stopColor={branchColorL} animate />
            </span>
            es Amis de Tobie
            <span className="absolute w-14 bottom-[1.67rem] right-[1.46rem] sm:w-24 sm:bottom-[3rem] sm:right-[2rem] z-0">
