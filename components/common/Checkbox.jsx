...
const Checkbox = ({ textColor, text, checked, onChange, disabled }) => {
  return (
    <div className="mx-1 text-justify">
      <label className="checkbox top-[3px] mr-2">
        <input
          id={text}
          type="checkbox"
          checked={checked}
      ...
      <label htmlFor={text} className={`font-nunito text-sm ${textColor}`}>
        {text}
      </label>
    </div>
  );
